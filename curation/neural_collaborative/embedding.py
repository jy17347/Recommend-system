...
def embedding_model(num_users, num_items, layers=[10], reg_layers=[0]):
    
    num_layer = len(layers)

    MF_embedding_item = Embedding(input_dim = num_users, output_dim = 6)
    ...
    print(type(user_input),type(item_input), "\n \n")
