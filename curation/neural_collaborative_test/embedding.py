...
def embedding_model(num_users, num_items, layers=[32,64,32,16,4]):
    ...
    MF_embedding_item = Embedding(input_dim = num_items+1, output_dim = 4)
    MLP_embedding_item = Embedding(input_dim = num_items+1, output_dim = 4) 
    
    user_input = Input(shape = (4,), dtype='float32', name='user_unput')
